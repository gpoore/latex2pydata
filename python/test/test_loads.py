...
def test_loads_any_verbatim():
    data_str = textwrap.dedent('''\
        # latex2pydata metadata: {"schema": {"key1": "Any", "key2": "Any", "key3": "verbatim", "key4": "verbatim"}}
        {
        "key1": "123",
        "key2": "{1, (2, 3)}",
        "key3": "verbatim",
        ...
        ''')
    assert latex2pydata.loads(data_str) == {"key1": 123, "key2": {1, (2, 3)}, "key3": "verbatim", "key4": "\r'\""}


def test_loads_scalar_schema_opt_arg():
    data_str = textwrap.dedent('''\
        # latex2pydata metadata: {"schema": {"key1": "int"}, "schema_missing": "verbatim"}
        {"key1": "123", "key2": "456",}
        ''')
    ...
    assert latex2pydata.loads(data_str, schema={"key2": "int"}, schema_missing='verbatim') == {"key1": "123", "key2": 456}
